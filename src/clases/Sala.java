...
public class Sala {
     ...
     * @param horarios 
     */
    public Sala(String id,String ubicacion,int maxCapacidad,String recursos,boolean estado,int calificacion,Horario horarios){
        setId(id);
     ...
     * @param horarios 
     */
    public Sala(String id,String ubicacion,int maxCapacidad,boolean estado,int calificacion,Horario horarios){
        setId(id);
        setUbicacion(ubicacion);
        setMaxCapacidad(maxCapacidad);
        setEstado(estado);
